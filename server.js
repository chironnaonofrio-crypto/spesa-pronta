...
(function(){
  ...
  try{
    ...
    if(typeof prev==='function' && !global.__v2875ServerBrainWrapped){
      publicServerBrainV2840=function(opts={}){
        const out=prev.call(this,opts||{})||{};
        try{
          out.version='V28.77 PRO CSS Render Always Visible';
          out.reasoningBusV2875={active:true,policy:'render inline sempre visibile + foto eliminabili + retry render',renderEngine:'V28.77 hard HTML/SVG fallback first',mobileSafe:true};
        }catch(_){ }
        return out;
      };
  ...
  console.log('[Spesa Pronta] V28.77 PRO CSS Render Always Visible active');
})();
