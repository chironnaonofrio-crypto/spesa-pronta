...
function emptyDb(){
  return { users:{}, households:{}, tokens:{}, meta:{ createdAt:Date.now(), version:'V27.96 RESTORE SCANNER BUTTONS' } };
}
function ensureDb(){
...
function writeDb(db){
  ...
  db.meta.version = 'V27.96 RESTORE SCANNER BUTTONS';
...
app.get('/api/health', (req,res) => {
  ...
  res.json({
    ok:true,
    app:'Spesa Pronta',
    version:'V27.96 RESTORE SCANNER BUTTONS',
