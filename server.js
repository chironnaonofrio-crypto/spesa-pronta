...
function emptyDb(){
  return { users:{}, households:{}, tokens:{}, meta:{ createdAt:Date.now(), version:'V27.89 SCANNER MERGED PILLS' } };
}
function ensureDb(){
...
function writeDb(db){
  ...
  db.meta.version = 'V27.89 SCANNER MERGED PILLS';
...
app.get('/api/health', (req,res) => {
  ...
  res.json({
    ok:true,
    app:'Spesa Pronta',
    version:'V27.89 SCANNER MERGED PILLS',
