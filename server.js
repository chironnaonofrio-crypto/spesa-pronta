...
function emptyDb(){
  return { users:{}, households:{}, tokens:{}, meta:{ createdAt:Date.now(), version:'V27.90 SCANNER PILLS FIXED' } };
}
function ensureDb(){
...
function writeDb(db){
  ...
  db.meta.version = 'V27.90 SCANNER PILLS FIXED';
...
app.get('/api/health', (req,res) => {
  ...
  res.json({
    ok:true,
    app:'Spesa Pronta',
    version:'V27.90 SCANNER PILLS FIXED',
