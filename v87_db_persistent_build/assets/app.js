...
function enhanceScannerQuickCards(){
  ...
  wrap.innerHTML=cards.map(card=>`<span role="listitem"><img class="quick-card-art" src="${card.img}" alt="${card.title}"><span class="quick-copy"><b>${card.title}</b><em>${card.sub}</em></span></span>`).join('');
}
