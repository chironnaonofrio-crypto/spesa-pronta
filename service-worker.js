const CACHE_NAME='spesa-pronta-v28-13-first-inventory-safe';
const ASSETS=['./','./index.html','./assets/styles.css?v=2813','./assets/app.v27-48-premium-mega-vision.js?v=2813','./assets/vision-seed-memory.json','./assets/vision-seed-memory.js?v=2813','./assets/vision-mega-index.js?v=2813','./assets/vision-mega-index.json','./assets/vision-neural-grocery.svg','./assets/illustrations/vision-ready-white-v2811.png','./clear-cache.html','./debug.html'];
