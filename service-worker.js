const CACHE_NAME='spesa-pronta-v28-71-pro-master-real-pixel-twin';
const ASSETS=['./','./index.html','./assets/styles.css?v=2871','./assets/app.v27-48-premium-mega-vision.js?v=2871','./assets/app.js?v=2871','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2871'];
