const CACHE_NAME='spesa-pronta-v28-75-pro-hard-render-visible';
const ASSETS=['./','./index.html','./assets/styles.css?v=2875','./assets/app.v27-48-premium-mega-vision.js?v=2875','./assets/app.js?v=2875','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2875'];
