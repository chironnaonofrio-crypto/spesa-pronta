const CACHE_NAME='spesa-pronta-v31-10-7-pro-3d-truth-gate-ocr-overlay';
const ASSETS=['./','./index.html','./assets/styles.css?v=31107','./assets/app.v27-48-premium-mega-vision.js?v=31107','./assets/app.js?v=31107','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=31107'];
