const CACHE_NAME='spesa-pronta-v28-40-server-brain-console';
const ASSETS=['./','./index.html','./assets/styles.css?v=2840','./assets/app.v27-48-premium-mega-vision.js?v=2840','./assets/app.js?v=2840','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html'];
