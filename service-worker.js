const CACHE_NAME='spesa-pronta-v28-72-pro-real-photo-twin-mobile-fix';
const ASSETS=['./','./index.html','./assets/styles.css?v=2872','./assets/app.v27-48-premium-mega-vision.js?v=2872','./assets/app.js?v=2872','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2872'];
