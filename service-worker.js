const CACHE_NAME='spesa-pronta-v31-10-2-premium-label-render-fix';
const ASSETS=['./','./index.html','./assets/styles.css?v=3190','./assets/app.v27-48-premium-mega-vision.js?v=3190','./assets/app.js?v=3190','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=3190'];
