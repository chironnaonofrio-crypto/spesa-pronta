const CACHE_NAME='spesa-pronta-v31-5-2-image-preview-restore';
const ASSETS=['./','./index.html','./assets/styles.css?v=3152','./assets/app.v27-48-premium-mega-vision.js?v=3152','./assets/app.js?v=3152','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=3152'];
