const CACHE_NAME='spesa-pronta-v28-78-render-tab-surgical-fix';
const ASSETS=['./','./index.html','./assets/styles.css?v=2878','./assets/app.v27-48-premium-mega-vision.js?v=2878','./assets/app.js?v=2878','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2878'];
