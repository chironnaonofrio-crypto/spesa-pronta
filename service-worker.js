const CACHE_NAME='spesa-pronta-v28-15-no-verify-pill';
const ASSETS=['./','./index.html','./assets/styles.css?v=2815','./assets/app.v27-48-premium-mega-vision.js?v=2815','./assets/vision-seed-memory.json','./assets/vision-seed-memory.js?v=2815','./assets/vision-mega-index.js?v=2815','./assets/vision-mega-index.json','./assets/vision-neural-grocery.svg','./assets/illustrations/vision-ready-white-v2811.png','./clear-cache.html','./debug.html'];
