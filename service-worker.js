const CACHE_NAME='spesa-pronta-v28-63-pro-true-product-vision-ocr-shield';
const ASSETS=['./','./index.html','./assets/styles.css?v=2863','./assets/app.v27-48-premium-mega-vision.js?v=2863','./assets/app.js?v=2863','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2863'];
