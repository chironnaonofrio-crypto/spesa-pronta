const CACHE_NAME='spesa-pronta-v28-61-pro-deep-visual-memory';
const ASSETS=['./','./index.html','./assets/styles.css?v=2861','./assets/app.v27-48-premium-mega-vision.js?v=2861','./assets/app.js?v=2861','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2861'];
