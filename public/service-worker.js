const CACHE_NAME='spesa-pronta-v28-43-object-folder-owner-lock-pro';
const ASSETS=['./','./index.html','./assets/styles.css?v=2843','./assets/app.v27-48-premium-mega-vision.js?v=2843','./assets/app.js?v=2843','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2843'];
