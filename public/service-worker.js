const CACHE_NAME='spesa-pronta-v28-68-pro-realistic-render';
const ASSETS=['./','./index.html','./assets/styles.css?v=2868','./assets/app.v27-48-premium-mega-vision.js?v=2868','./assets/app.js?v=2868','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2868'];
