const CACHE_NAME='spesa-pronta-v30-3-google-block-safe-render';
const ASSETS=['./','./index.html','./assets/styles.css?v=3000','./assets/app.v27-48-premium-mega-vision.js?v=3000','./assets/app.js?v=3000','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=3000'];
