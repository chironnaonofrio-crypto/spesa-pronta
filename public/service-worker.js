const CACHE_NAME='spesa-pronta-v28-70-pro-master-visual-twin';
const ASSETS=['./','./index.html','./assets/styles.css?v=2870','./assets/app.v27-48-premium-mega-vision.js?v=2870','./assets/app.js?v=2870','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2870'];
