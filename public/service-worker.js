const CACHE_NAME='spesa-pronta-v28-64-pro-human-like-pixel-ocr';
const ASSETS=['./','./index.html','./assets/styles.css?v=2864','./assets/app.v27-48-premium-mega-vision.js?v=2864','./assets/app.js?v=2864','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2864'];
