const CACHE_NAME='spesa-pronta-v28-79-real-pixel-render';
const ASSETS=['./','./index.html','./assets/styles.css?v=2910','./assets/app.v27-48-premium-mega-vision.js?v=2910','./assets/app.js?v=2910','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2910'];
