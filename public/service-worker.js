const CACHE_NAME='spesa-pronta-v31-10-3-balanced-render-fix';
const ASSETS=['./','./index.html','./assets/styles.css?v=31103','./assets/app.v27-48-premium-mega-vision.js?v=31103','./assets/app.js?v=31103','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=31103'];
