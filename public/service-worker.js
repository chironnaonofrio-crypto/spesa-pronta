const CACHE_NAME='spesa-pronta-v29-2-pro-360-intelligent-render';
const ASSETS=['./','./index.html','./assets/styles.css?v=2920','./assets/app.v27-48-premium-mega-vision.js?v=2920','./assets/app.js?v=2920','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2920'];
