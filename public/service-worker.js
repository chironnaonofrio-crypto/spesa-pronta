const CACHE_NAME='spesa-pronta-v28-77-pro-css-render-always-visible';
const ASSETS=['./','./index.html','./assets/styles.css?v=2877','./assets/app.v27-48-premium-mega-vision.js?v=2877','./assets/app.js?v=2877','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2877'];
