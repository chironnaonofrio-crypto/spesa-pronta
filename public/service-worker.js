const CACHE_NAME='spesa-pronta-v28-76-pro-mobile-render-stack';
const ASSETS=['./','./index.html','./assets/styles.css?v=2876','./assets/app.v27-48-premium-mega-vision.js?v=2876','./assets/app.js?v=2876','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2876'];
