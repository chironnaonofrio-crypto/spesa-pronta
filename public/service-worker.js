const CACHE_NAME='spesa-pronta-v28-54-pro-cost-meter-semantic-signature';
const ASSETS=['./','./index.html','./assets/styles.css?v=2854','./assets/app.v27-48-premium-mega-vision.js?v=2854','./assets/app.js?v=2854','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2854'];
