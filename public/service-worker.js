const CACHE_NAME='spesa-pronta-v28-45-brain-owner-photo-console';
const ASSETS=['./','./index.html','./assets/styles.css?v=2845','./assets/app.v27-48-premium-mega-vision.js?v=2845','./assets/app.js?v=2845','./assets/vision-seed-memory.json','./clear-cache.html','./debug.html','./server-brain.html?v=2845'];
