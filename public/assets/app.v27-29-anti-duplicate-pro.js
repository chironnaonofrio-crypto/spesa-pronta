window.SPESA_PRONTA_VERSION='v27.29-anti-duplicate-pro';
...
function getScanCompletionStatus(el, result={}){
  ...
  const checks=[
    ...
    {key:'brand', label:'Marca', ok:!!s.brand || !!result.brand || el.dataset.voiceBrandDone==='1', warn:Number(result.confidence||0)<0.68 && !s.brand},
