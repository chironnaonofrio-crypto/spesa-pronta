window.SPESA_PRONTA_VERSION='v28.45-professional-slide-slim';
...
function confirmScanResult(el,result,silent=false){
  ...
  const confirmedLearning=compactLearningPayloadProduct({productName,brand,size,qty,unit,category,expiryDate,damageNote,barcode,userCorrections,productMemory:savedProductMemory||internalProductMemory,confirmedAt:Date.now(),visualFeatures:result.visualFeatures||null,visualSignature:result.visualSignature||'',visibleEvidence:result.visibleEvidence||[],detectedText:result.detectedText||[],confidence:result.confidence||null,cloudVision:!!result.cloudVision,autonomousVision:!!result.autonomousVision,memoryVision:!!result.memoryVision,localFirst:!!result.localFirst,learningAudit:{teacherUsed:!!result.cloudVision,recognizedByLocalOrServer:!!(result.localFirst||result.autonomousVision||result.memoryVision),memoryUpdated:true,barcode:!!barcode,userCorrections:Object.keys(userCorrections||{}).filter(k=>userCorrections[k]?.edited)}});
...
(function(){
  try{
    window.SPESA_PRONTA_VERSION='v28.45-professional-slide-slim';
    window.SPESA_PRONTA_BUILD=Object.assign({}, window.SPESA_PRONTA_BUILD||{}, {version:'V28.45', preflightBugSweep:'regex_boundary_cache_runtime_marker'});
...
(function(){
  try{
    window.SPESA_PRONTA_VERSION='v28.45-professional-slide-slim';
    window.SPESA_PRONTA_BUILD=Object.assign({}, window.SPESA_PRONTA_BUILD||{}, {version:'V28.45', openAiConnectionGuard:'server_key_aliases_real_healthcheck_model_fallback'});
...
(function(){
  ...
  try{
    window.SPESA_PRONTA_VERSION='v28.45-professional-slide-slim';
    window.SPESA_PRONTA_BUILD=Object.assign({}, window.SPESA_PRONTA_BUILD||{}, {version:'V28.45', ocrBoostPro:'highres_contrast_teacher_image_label_expiry_barcode', openaiHomePro:'premium_landing_fridge_mount'});
