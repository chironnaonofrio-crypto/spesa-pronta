window.SPESA_PRONTA_VERSION='v27.22-max-vision';
...
async function analyzeGroceryDataUrl(dataUrl,fileName='photo.jpg'){
  ...
  if(summary.count>1){
    ...
    $('#scannerStatus').textContent=(result.needsManual?'Controllo manuale: completa i dati, soprattutto nome, quantità e scadenza.':'Vision AI completata: ho incrociato riconoscimento prodotto, OCR e memoria locale. Controlla e conferma: ogni conferma mi aiuta a diventare più precisa con i tuoi prodotti.');
  }
  document.querySelector('.scanning-preview')?.remove();
}
